...
func createHybridIdentity(x25519_i *X25519Identity, kyber_i *KyberIdentity) (*HybridIdentity, error) {
	i := &HybridIdentity{
...
func createHybridRecipient(x25519_r *X25519Recipient, kyber_r *KyberRecipient) (*HybridRecipient, error) {
	r := &HybridRecipient{
